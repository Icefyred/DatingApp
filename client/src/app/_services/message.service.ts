...
export class MessageService {
  ...
  stopHubConnection(){
    //this is to avoid that the destroy method() isnt called prior to this stopHubConnection
    //, so it won't create an exception of trying to destroy something that is already destroyed
